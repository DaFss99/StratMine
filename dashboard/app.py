...
def load_data():
    ...
    df_alvara = pd.read_csv('databases/dashboard/1.dashboard_CM_alvara.csv')
    df_lavra = pd.read_csv('databases/dashboard/1.dashboard_CM_lavra.csv')
    df_arr = pd.read_csv('databases/dashboard/2.dashboard_cefem_arrecadacao.csv')
    df_bar = pd.read_csv('databases/dashboard/3.dashboard_sigbm_barragens.csv')
    df_div = pd.read_csv('databases/dashboard/4.dashboard_divida_ativa.csv')
